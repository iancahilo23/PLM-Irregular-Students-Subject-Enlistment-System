...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Note: Birthdate input was in your JS but not used for login in the SQL schema.
    // We will keep the variable for the datepicker, but it's not sent to login.php.
    ...
    loginForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                localStorage.setItem('plm_student_name', data.studentId); // Stores ID to display in dashboard
